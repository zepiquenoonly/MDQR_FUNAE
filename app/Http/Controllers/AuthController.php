...
class AuthController extends Controller {
    ...
    /**
     * Normaliza o nome do role para o frontend
     */
    ...
    /**
     * Obtém o role normalizado do usuário
     */
    public function getUserNormalizedRole($user = null)
    {
        if (!$user) {
            $user = Auth::user();
        }
    ...
    public function showProject($projectId): Response {
        ...
        return Inertia::render('Utente/Dashboard', [
            'user' => [
                ...
                'name' => $user->name,
                'email' => $user->email,
                'role' => $this->getUserNormalizedRole($user),
