...
class UtenteDashboardController extends Controller
{
    ...
    private function transformGrievance(Grievance $grievance): array
    {
        ...
        return [
            ...
            'priority_label' => $grievance->priority_label,
            ...
            'created_at' => optional($grievance->created_at)->toIso8601String(),
            ...
            'escalated_at' => optional($grievance->escalated_at)->toIso8601String(),
            ...
            'resolved_by' => $grievance->resolvedBy ? [
                'id' => $grievance->resolvedBy->id,
                'name' => $grievance->resolvedBy->name,
                'email' => $grievance->resolvedBy->email,
            ] : null,
