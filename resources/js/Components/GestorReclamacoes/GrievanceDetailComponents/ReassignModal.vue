<template>
  <div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-6">
    <div
      class="bg-white dark:bg-dark-secondary rounded-2xl w-full max-w-xl max-h-[95vh] flex flex-col shadow-2xl"
    >
      <!-- Header -->
      ...
      <div class="p-8 flex-1 overflow-y-auto">
        <div class="space-y-6">
          ...
          <div>
            ...
            <!-- Informação do técnico selecionado -->
            <div
          ...
          >
            ...
            <ul class="text-sm text-gray-700 dark:text-gray-300 space-y-2">
              <li class="flex items-start gap-2">
                ...
                <div>
                  <span class="font-medium"
                    >O técnico actual será notificado da alteração</span
                  >
              ...
              <li class="flex items-start gap-2">
                ...
                <div>
                  <span class="font-medium"
                    >O novo técnico será notificado da atribuição</span
                  >
                  <p class="text-xs text-gray-500 mt-0.5">
