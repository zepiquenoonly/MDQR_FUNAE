<template>
  <div class="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-6">
    <div
      class="bg-white dark:bg-dark-secondary rounded-2xl w-full max-w-4xl max-h-[95vh] flex flex-col shadow-2xl"
    >
      <!-- Header -->
          ...
          <div class="flex items-center gap-4">
            <div class="flex-1">
              <p class="text-base font-bold text-gray-900 dark:text-gray-100 mb-1">
                Submissão Nº:
                <span class="text-brand text-lg">{{ complaint.reference_number }}</span>
              </p>
          ...
          <div>
            <div class="mb-4">
              ...
              <p class="text-base text-gray-700 dark:text-gray-400 leading-relaxed">
                Selecione cuidadosamente o motivo principal que justifica o encaminhamento
                desta submissão para análise directorial. Esta informação ajudará o
                Director a compreender a natureza e a urgência do caso.
              </p>
            </div>
              ...
              >
                ...
                >
                  ...
                  <option
                    ...
                    class="py-3 text-base hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
                    Disputa Técnica - Necessita arbitragem e decisão de alto nível técnico
                  </option>
                </optgroup>
                <optgroup
                ...
                >
                  <option
                    ...
                    class="py-3 text-base hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
                    Aprovação de Orçamento - Requer autorização financeira extraordinária
                  </option>
                  <option
                ...
                >
                  ...
                  <option
                    ...
                    class="py-3 text-base hover:bg-gray-100 dark:hover:bg-gray-800"
                  >
                    Relações Externas e Institucionais - Envolve parceiros estratégicos ou
            ...
            <div class="flex items-center justify-between mb-4">
              <div>
                ...
                <p class="text-base text-gray-700 dark:text-gray-400">
                  Forneça informações detalhadas e contextuais para orientar a análise do
                  Director
                </p>
              </div>
            </div>
...
5. Qualquer informação adicional relevante para a análise do director"
          ...
          <div
            class="mt-8 p-6 bg-gradient-to-r from-gray-50 to-slate-50 dark:from-gray-800/60 dark:to-slate-800/60 border-2 border-gray-200 dark:border-gray-700 rounded-2xl shadow-lg"
          >
            <h4
              class="text-xl font-bold text-gray-900 dark:text-dark-text-primary mb-4 flex items-center gap-3"
            >
            ...
            <div class="space-y-4">
              <div
                class="flex items-center justify-between p-3 bg-white/50 dark:bg-gray-900/30 rounded-xl"
              >
                <span class="text-base font-medium text-gray-700 dark:text-gray-300"
                  >Submissão a Encaminhar</span
                >
                <span
                  class="text-base font-bold text-gray-900 dark:text-dark-text-primary"
                  >{{ complaint.reference_number }}</span
                >
              </div>
              <div
                class="flex items-center justify-between p-3 bg-white/50 dark:bg-gray-900/30 rounded-xl"
              ...
              >
                <span class="text-base font-medium text-gray-700 dark:text-gray-300"
                  >Motivo Selecionado</span
                >
                <span
                  class="text-base font-bold text-gray-900 dark:text-dark-text-primary text-right max-w-xs"
                  >{{ getReasonLabel(form.reason) || "Aguardando seleção" }}</span
                >
              </div>
            </div>
          </div>
