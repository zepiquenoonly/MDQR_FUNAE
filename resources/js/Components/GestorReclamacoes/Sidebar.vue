<template>
  <aside
    class="bg-brand dark:bg-dark-secondary text-white h-full flex flex-col overflow-hidden"
  >
    <!-- Brand/Logo Section -->
      ...
      <div class="flex items-center space-x-2 sm:space-x-3 min-w-0">
        ...
        >
          <div class="transition-all duration-300 overflow-hidden min-w-0 flex-1">
            <h1 class="font-semibold text-base sm:text-lg whitespace-nowrap truncate">
              {{ dashboardTitle }}
            </h1>
            <p class="text-orange-100 dark:text-orange-200 text-xs sm:text-sm truncate">
              {{ dashboardSubtitle }}
            </p>
          </div>
        </div>
