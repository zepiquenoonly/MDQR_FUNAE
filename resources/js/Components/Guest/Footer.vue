<template>
  <footer
    id="contactos"
    class="bg-brand-footer text-white py-12 md:py-16 px-4 sm:px-6 lg:px-8"
  >
    <!-- GRID PRINCIPAL -->
    <div class="max-w-7xl mx-auto grid grid-cols-2 gap-8 sm:grid-cols-2 md:grid-cols-4">
      ...
      <div class="col-span-1 md:col-span-1">
        <div class="flex flex-col items-start gap-4">
          ...
          <p class="text-white/90 leading-relaxed text-sm md:text-base text-left md:mt-2">
    ...
    <div class="max-w-7xl mx-auto mt-10 pt-6 border-t border-white/20">
      <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex space-x-6">
          ...
          <a href="/email-test" class="text-white hover:text-white text-xs opacity-50"
            >Teste Email</a
          >
        </div>
      </div>
