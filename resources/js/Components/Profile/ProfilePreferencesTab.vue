<template>
    <div class="bg-white rounded-xl shadow-sm p-6">
        <h3 class="text-2xl font-semibold text-gray-800 mb-6">Preferências do Sistema</h3>

        <div class="space-y-6">
            <!-- Idioma e Região -->
            <div class="border border-gray-200 rounded-lg p-6">
                <h4 class="text-lg font-semibold text-gray-800 mb-4">Idioma e Região</h4>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Idioma</label>
                        <select v-model="preferences.language"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-0 focus:ring-orange-500 focus:border-brand transition-colors">
            ...
            <!-- Aparência -->
            <div class="border border-gray-200 rounded-lg p-6">
                <h4 class="text-lg font-semibold text-gray-800 mb-4">Aparência</h4>
            ...
            <div class="border border-red-200 rounded-lg p-6 bg-red-50">
                <h4 class="text-lg font-semibold text-red-800 mb-4">Zona Perigosa</h4>
                <div class="space-y-4">
                    <p class="text-red-700">Uma vez que apague a sua conta, não há retorno. Por favor, tenha certeza.
                    </p>
