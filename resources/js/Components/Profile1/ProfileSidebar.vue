<template>
  <aside
    class="relative flex flex-col h-full text-white transition-all duration-300 rounded-md bg-gradient-to-b from-orange-600 via-orange-500 to-red-500 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
