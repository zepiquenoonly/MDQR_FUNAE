<template>
    <Layout role="admin">
        <div class="p-6 max-w-2xl mx-auto">
            <div class="mb-8">
                <Link href="/admin/departments" class="inline-flex items-center text-gray-600 hover:text-primary-600 font-medium mb-4 transition-colors group">
                ...
                <div class="relative overflow-hidden rounded-2xl p-6 shadow-lg border border-primary-400/30">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-orange-50 mt-1">Atualize as informações do departamento</p>
                    </div>
                </div>
            </div>
...
function submit() {
    form.put(`/admin/departments/${props.department.id}`, {
        ...
        onError: () => {
            error('Erro ao atualizar departamento. Tente novamente.');
        }
    });
}
</script>
