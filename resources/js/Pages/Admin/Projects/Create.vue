            ...
            <div class="mb-8">
                ...
                <div class="relative overflow-hidden rounded-2xl p-6 shadow-lg border border-primary-400/30">
                    ...
                    <div class="relative z-10">
                        <h1 class="text-3xl font-bold text-white drop-shadow-lg">Novo Projecto</h1>
                        <p class="text-orange-50 mt-1">Preencha os dados para criar um novo projecto</p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <button type="submit" :disabled="form.processing"
                        ...
                        <span>{{ form.processing ? 'A criar...' : 'Criar Projecto' }}</span>
                    </button>
                </div>
            </form>
        </div>
...
function submit() {
    form.post('/admin/projects', {
        onSuccess: () => {
            success('Projecto criado com sucesso!');
        },
        onError: () => {
            error('Erro ao criar projecto. Tente novamente.');
        }
    });
}
</script>
