<template>
    <Layout role="admin">
        <div class="p-6">
            ...
            <div class="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl p-6 mb-8 border border-white/30 shadow-lg shadow-primary-500/5">
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-8 h-8 bg-gradient-to-br from-primary-500/20 to-purple-600/20 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/30">
                        <svg class="w-4 h-4 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4a1 1 0 011-1h16a1 1 0 011 1v2.586a1 1 0 01-.293.707l-6.414 6.414a1 1 0 00-.293.707V17l-4 4v-6.586a1 1 0 00-.293-.707L3.293 7.293A1 1 0 013 6.586V4z"/>
                        </svg>
                    </div>
                    <h4 class="font-bold text-gray-800 text-base">Filtros de Pesquisa</h4>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Search Filter -->
                    <div class="bg-white/50 backdrop-blur-sm p-4 rounded-2xl border border-white/40 shadow-lg shadow-purple-500/5 hover:shadow-xl hover:shadow-purple-500/10 transition-all duration-300 hover:-translate-y-0.5">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Pesquisar Utilizadores</label>
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="w-full pl-10 pr-4 py-3 bg-white/80 backdrop-blur-sm border border-white/50 rounded-xl text-sm focus:border-purple-400 focus:ring-2 focus:ring-purple-200/50 transition-all duration-200"
                            >
                        </div>
                    </div>

                    <!-- Role Filter -->
                    <div class="bg-white/50 backdrop-blur-sm p-4 rounded-2xl border border-white/40 shadow-lg shadow-blue-500/5 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-0.5">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Filtrar por Role</label>
                        <select
                            v-model="roleFilter"
                            class="w-full px-4 py-3 bg-white/80 backdrop-blur-sm border border-white/50 rounded-xl text-sm focus:border-blue-400 focus:ring-2 focus:ring-blue-200/50 transition-all duration-200 appearance-none cursor-pointer"
                        >
