...
<body>
    <div class="header">
        <h1>👤 Reclamação Atribuída</h1>
    </div>
    
    <div class="content">
        <p>Prezado(a),</p>
        
        <p>A sua reclamação foi atribuída a um técnico especializado da nossa equipa.</p>
        ...
        <div class="info-box">
            ...
            <ul>
                <li>A sua reclamação está a ser analisada por um técnico especializado</li>
